		...
		if (length && length > 2 && data[0] == '4' && data[1] == '2')
		{
			...
			if (s != "")
			{
				...
				if (event == "telemetry")
				{
					...
					// later we will interpolate there waypoints with a spline and fill it in with more points that contol spline
					...
					//Start with all of the previous path points from last line
					...
					for (int i = 1; i <= 50 - previous_path_x.size(); i++)
					{
						...
						//rotate back to normal after rotatiing it earlier
